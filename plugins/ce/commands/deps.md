...
Analyze and manage project dependencies for security vulnerabilities, outdated packages, and upgrade opportunities.

Arguments:

- `$ARGUMENTS`: Optional action (audit, upgrade, outdated). Defaults to audit if not specified.
